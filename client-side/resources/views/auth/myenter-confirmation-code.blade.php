...
<head>
    ...
    <title>輸入驗證碼 Enter Confirmation Code</title>
    <!-- Vite + Tailwind -->
    ...
    <main class="flex justify-center items-center min-h-screen bg-cover bg-center h-screen w-full px-5"
        ...
        <section
            ...
            <header class="flex items-center gap-3 mb-6 text-2xl font-semibold text-gray-500 w-full max-w-[320px]">
                ...
                <h1 class="text-2xl font-semibold leading-9 text-gray-500">Enter Confirmation Code</h1>
            </header>

            <form method="POST" action="{{ route('myenter-confirmation-code') }}"
