...
@section('meta_description', '新增您的收件地址')
@section('meta_keywords', '收件地址, 會員中心')
@section('breadcrumb_title', '新增收件地址')

@section('main_content')
    <div class="w-full p-4 sm:p-6 bg-white rounded-lg shadow-sm">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-xl sm:text-2xl font-bold text-brandGrey-normal">新增收件地址</h1>
        ...
        <form action="{{ route('user.address.store') }}" method="POST" class="max-w-lg mx-auto">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="address_label" name="address_label" placeholder="例如：住家、公司" class="w-full px-3 py-2 border border-brandGrey-lightActive rounded-md focus:outline-none focus:ring-1 focus:ring-brandBlue-normal" required>
                </div>
                ...
                <div class="border border-brandGrey-light rounded-lg p-4">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" id="recipient_name" name="recipient_name" placeholder="王小明" class="w-full px-3 py-2 border border-brandGrey-lightActive rounded-md focus:outline-none focus:ring-1 focus:ring-brandBlue-normal" required>
                        </div>
                        
                        <div>
                            <label for="recipient_phone" class="block text-sm font-medium text-brandGrey-normal mb-1">收件人電話</label>
                            <input type="tel" id="recipient_phone" name="recipient_phone" placeholder="0912-345-678" class="w-full px-3 py-2 border border-brandGrey-lightActive rounded-md focus:outline-none focus:ring-1 focus:ring-brandBlue-normal" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="border border-brandGrey-light rounded-lg p-4">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" id="postal_code" name="postal_code" placeholder="110" class="w-full px-3 py-2 border border-brandGrey-lightActive rounded-md focus:outline-none focus:ring-1 focus:ring-brandBlue-normal" required>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="address" name="address" placeholder="信義路五段7號" class="w-full px-3 py-2 border border-brandGrey-lightActive rounded-md focus:outline-none focus:ring-1 focus:ring-brandBlue-normal" required>
                        </div>
                    </div>
                </div>
